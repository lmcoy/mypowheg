...
double UU_UD::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UU_UD::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1P0_3(w[1], w[4], pars.GC_11, ZERO, w[10]);
    ...
    FFV2_0(w[11], w[5], w[7], pars.GC_100, amp[2]);
    FFV1_0(w[12], w[5], w[10], pars.GC_11, amp[3]);
