...
double GDX_GUX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double GDX_GUX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1_1(w[1], w[0], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[5], w[4], pars.GC_11, ZERO, w[11]);
    FFV1_1(w[10], w[4], pars.GC_11, ZERO, w[12]);
    FFV1_2(w[5], w[0], pars.GC_11, ZERO, w[13]);
    FFV1_1(w[1], w[4], pars.GC_11, ZERO, w[14]);
