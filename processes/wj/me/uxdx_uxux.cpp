...
double UXDX_UXUX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UXDX_UXUX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1P0_3(w[4], w[0], pars.GC_11, ZERO, w[6]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[7]);
    FFV1_2(w[5], w[6], pars.GC_11, ZERO, w[8]);
    FFV1_1(w[1], w[6], pars.GC_11, ZERO, w[9]);
    FFV1P0_3(w[5], w[0], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[4], w[10], pars.GC_11, ZERO, w[11]);
    FFV2_2(w[4], w[7], pars.GC_100, ZERO, w[12]);
    ...
    FFV1_0(w[12], w[1], w[10], pars.GC_11, amp[3]);
