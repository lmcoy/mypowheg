...
// Process: s d~ > mu+ vm s u~ WEIGHTED<=6 @1

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double USX_UCX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double USX_UCX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    jamp[0] = +1. / 2. * (+amp[0] + amp[1]);
    jamp[1] = +1. / 2. * (-1. / 3. * amp[0] - 1. / 3. * amp[1]);
