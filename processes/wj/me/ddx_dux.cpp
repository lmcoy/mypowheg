...
// Process: d d~ > mu+ vm d u~
// Process: s s~ > mu+ vm s c~

double DDX_DUX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double DDX_DUX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV2_2(w[5], w[7], pars.GC_100, ZERO, w[9]);
    FFV1P0_3(w[0], w[4], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[5], w[10], pars.GC_11, ZERO, w[11]);
