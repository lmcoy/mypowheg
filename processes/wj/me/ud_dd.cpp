...
double UD_DD::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UD_DD::calculate_wavefunctions(const int perm[], const int hel[],
                                      const Parameters_sm &pars,
                                      double momenta[][4]) {

    constexpr std::complex<double> ZERO(0.0, 0.0);

    const int nwavefuncs = 12;
    ...
    FFV1_0(w[9], w[5], w[6], pars.GC_11, amp[1]);
