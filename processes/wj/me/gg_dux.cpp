...
double GG_DUX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double GG_DUX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    vxxxxx(momenta[perm[1]], mME[1], hel[1], -1, w[1]);
    ...
    VVV1P0_1(w[0], w[1], pars.GC_10, ZERO, w[6]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[7]);
    FFV1_1(w[4], w[6], pars.GC_11, ZERO, w[8]);
    FFV1_2(w[5], w[6], pars.GC_11, ZERO, w[9]);
    FFV1_1(w[4], w[0], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[5], w[1], pars.GC_11, ZERO, w[11]);
    FFV1_1(w[10], w[1], pars.GC_11, ZERO, w[12]);
    FFV1_2(w[5], w[0], pars.GC_11, ZERO, w[13]);
    FFV1_1(w[4], w[1], pars.GC_11, ZERO, w[14]);
    FFV1_2(w[13], w[1], pars.GC_11, ZERO, w[15]);
    ...
    FFV2_0(w[5], w[8], w[7], pars.GC_100, amp[0]);
    FFV2_0(w[9], w[4], w[7], pars.GC_100, amp[1]);
    FFV2_0(w[11], w[10], w[7], pars.GC_100, amp[2]);
    FFV2_0(w[5], w[12], w[7], pars.GC_100, amp[3]);
    FFV2_0(w[13], w[14], w[7], pars.GC_100, amp[4]);
    FFV2_0(w[15], w[4], w[7], pars.GC_100, amp[5]);
    FFV2_0(w[5], w[16], w[7], pars.GC_100, amp[6]);
    FFV2_0(w[17], w[4], w[7], pars.GC_100, amp[7]);
