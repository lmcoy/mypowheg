...
double GDX_UXA::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double GDX_UXA::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1_2(w[4], w[0], pars.GC_11, ZERO, w[6]);
    ...
    FFV1_1(w[1], w[0], pars.GC_11, ZERO, w[12]);
    FFV1_2(w[4], w[5], pars.GC_2, ZERO, w[13]);
    FFV2_3(w[4], w[12], pars.GC_100, pars.MuW, w[14]);
