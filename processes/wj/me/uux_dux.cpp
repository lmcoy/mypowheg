...
double UUX_DUX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UUX_DUX::calculate_wavefunctions(const int perm[], const int hel[],
                                        const Parameters_sm &pars,
                                        double momenta[][4]) {

    constexpr std::complex<double> ZERO(0.0, 0.0);

    const int nwavefuncs = 13;
    ...
    FFV1P0_3(w[0], w[1], pars.GC_11, ZERO, w[6]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[7]);
    FFV1_2(w[5], w[6], pars.GC_11, ZERO, w[8]);
    FFV1_1(w[4], w[6], pars.GC_11, ZERO, w[9]);
    FFV1P0_3(w[5], w[1], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[0], w[10], pars.GC_11, ZERO, w[11]);
    FFV2_2(w[0], w[7], pars.GC_100, ZERO, w[12]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    const int namplitudes = 4;
    std::complex<double> amp[namplitudes];
    FFV2_0(w[8], w[4], w[7], pars.GC_100, amp[0]);
    FFV2_0(w[5], w[9], w[7], pars.GC_100, amp[1]);
    FFV2_0(w[11], w[4], w[7], pars.GC_100, amp[2]);
    FFV1_0(w[12], w[4], w[10], pars.GC_11, amp[3]);
