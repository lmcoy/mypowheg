...
//
// 2016 07 12: modified by Lennart Oymanns
//
//==========================================================================
...
// Process: u d~ > mu+ vm d d~ WEIGHTED<=6 @1
// Process: c s~ > mu+ vm s s~ WEIGHTED<=6 @1

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double UDX_DDX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UDX_DDX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1P0_3(w[5], w[1], pars.GC_11, ZERO, w[6]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[7]);
    FFV1_2(w[0], w[6], pars.GC_11, ZERO, w[8]);
    FFV2_2(w[0], w[7], pars.GC_100, ZERO, w[9]);
    FFV1P0_3(w[5], w[4], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[0], w[10], pars.GC_11, ZERO, w[11]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    static const int namplitudes = 4;
    std::complex<double> amp[namplitudes];
    FFV2_0(w[8], w[4], w[7], pars.GC_100, amp[0]);
    FFV1_0(w[9], w[4], w[6], pars.GC_11, amp[1]);
    FFV2_0(w[11], w[1], w[7], pars.GC_100, amp[2]);
    FFV1_0(w[9], w[1], w[10], pars.GC_11, amp[3]);
