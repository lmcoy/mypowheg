...
// Process: u u~ > mu+ vm s c~ WEIGHTED<=6 @1
// Process: c c~ > mu+ vm d u~ WEIGHTED<=6 @1
// Process: d d~ > mu+ vm s c~ WEIGHTED<=6 @1
// Process: s s~ > mu+ vm d u~ WEIGHTED<=6 @1

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double UUX_SCX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UUX_SCX::calculate_wavefunctions(const int perm[], const int hel[],
