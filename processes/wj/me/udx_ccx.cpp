...
// Process: u d~ > mu+ vm c c~ WEIGHTED<=6 @1
// Process: u d~ > mu+ vm s s~ WEIGHTED<=6 @1
// Process: c s~ > mu+ vm u u~ WEIGHTED<=6 @1
// Process: c s~ > mu+ vm d d~ WEIGHTED<=6 @1

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double UDX_CCX::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double UDX_CCX::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1P0_3(w[5], w[4], pars.GC_11, ZERO, w[6]);
