...
TEST(UUX_SCX, PS1) {
    ...
    ASSERT_NEAR(m2 / 7.485622276974138542509903e-15, 1.0, 1e-6);

    // b~ b > mu+ vm c~ s
    m2 = me.Calculate(ps, perm1, param) * Vcs2;
    ASSERT_NEAR(m2 / 1.400799970066606256657078e-13, 1.0, 1e-6);
    ...
    ASSERT_NEAR(m2 / 1.683616005230545630826595e-18, 1.0, 1e-6);
    ...
    ASSERT_NEAR(m2 / 2.480692958598175479711880e-16, 1.0, 1e-6);
