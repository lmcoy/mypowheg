...
// Process: g u > mu+ vm g d WEIGHTED<=6 @1
// Process: g c > mu+ vm g s WEIGHTED<=6 @1

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double GU_GD::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
double GU_GD::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    VVV1P0_1(w[0], w[4], pars.GC_10, ZERO, w[6]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[7]);
    FFV1_1(w[5], w[6], pars.GC_11, ZERO, w[8]);
    FFV1_2(w[1], w[6], pars.GC_11, ZERO, w[9]);
    FFV1_1(w[5], w[0], pars.GC_11, ZERO, w[10]);
    FFV1_2(w[1], w[4], pars.GC_11, ZERO, w[11]);
    FFV1_1(w[10], w[4], pars.GC_11, ZERO, w[12]);
    FFV1_2(w[1], w[0], pars.GC_11, ZERO, w[13]);
    FFV1_1(w[5], w[4], pars.GC_11, ZERO, w[14]);
    FFV1_2(w[13], w[4], pars.GC_11, ZERO, w[15]);
    FFV1_1(w[14], w[0], pars.GC_11, ZERO, w[16]);
    FFV1_2(w[11], w[0], pars.GC_11, ZERO, w[17]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    const int namplitudes = 8;
    std::complex<double> amp[namplitudes];
    FFV2_0(w[1], w[8], w[7], pars.GC_100, amp[0]);
    FFV2_0(w[9], w[5], w[7], pars.GC_100, amp[1]);
    FFV2_0(w[11], w[10], w[7], pars.GC_100, amp[2]);
    FFV2_0(w[1], w[12], w[7], pars.GC_100, amp[3]);
    FFV2_0(w[13], w[14], w[7], pars.GC_100, amp[4]);
    FFV2_0(w[15], w[5], w[7], pars.GC_100, amp[5]);
    FFV2_0(w[1], w[16], w[7], pars.GC_100, amp[6]);
    FFV2_0(w[17], w[5], w[7], pars.GC_100, amp[7]);
