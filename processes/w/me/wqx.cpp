...
double Wqx::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
void Wqx::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1_2(w[4], w[0], pars.GC_11, ZERO, w[5]);
    FFV2_3(w[2], w[3], pars.GC_100, pars.MuW, w[6]);
    FFV1_1(w[1], w[0], pars.GC_11, ZERO, w[7]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    FFV2_0(w[5], w[1], w[6], pars.GC_100, amp[0]);
    FFV2_0(w[4], w[7], w[6], pars.GC_100, amp[1]);
}
