...
double ME_gu_mupmumu::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
void ME_gu_mupmumu::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV2_5_0(w[5], w[4], w[7], pars.GC_51, pars.GC_58, amp[1]);
    FFV1_0(w[1], w[8], w[6], pars.GC_2, amp[2]);
    FFV2_5_0(w[1], w[8], w[7], pars.GC_51, pars.GC_58, amp[3]);
}
double ME_gu_mupmumu::matrix_gu_mupmumu() {
