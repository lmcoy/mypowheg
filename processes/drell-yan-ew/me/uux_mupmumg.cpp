...
double ME_uux_mupmumg::Calculate(const Phasespace::Phasespace &ps,
...
void
ME_uux_mupmumg::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1_2(w[0], w[4], param_aS.GC_11, std::complex<double>(0.0, 0.0), w[5]);
    FFV1P0_3(w[2], w[3], pars.GC_3, std::complex<double>(0.0, 0.0), w[6]);
    FFV2_4_3(w[2], w[3], pars.GC_50, pars.GC_59, pars.MuZ, w[7]);
    FFV1_1(w[1], w[4], param_aS.GC_11, std::complex<double>(0.0, 0.0), w[8]);

    // Calculate all amplitudes
    // Amplitude(s) for diagram number 0
    FFV1_0(w[5], w[1], w[6], pars.GC_2, amp[0]);
    FFV2_5_0(w[5], w[1], w[7], pars.GC_51, pars.GC_58, amp[1]);
    FFV1_0(w[0], w[8], w[6], pars.GC_2, amp[2]);
    FFV2_5_0(w[0], w[8], w[7], pars.GC_51, pars.GC_58, amp[3]);
}

double ME_uux_mupmumg::matrix_uux_mupmumg() {
