...
// Process: d d~ > mu+ mu- g WEIGHTED=5

//--------------------------------------------------------------------------
// Evaluate |M|^2, part independent of incoming flavour.

double ME_ddx_mupmumg::Calculate(const Phasespace::Phasespace &ps,
...
void
ME_ddx_mupmumg::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV2_3_0(w[5], w[1], w[7], pars.GC_50, pars.GC_58, amp[1]);
    FFV1_0(w[0], w[8], w[6], pars.GC_1, amp[2]);
    FFV2_3_0(w[0], w[8], w[7], pars.GC_50, pars.GC_58, amp[3]);
}
double ME_ddx_mupmumg::matrix_ddx_mupmumg() {
