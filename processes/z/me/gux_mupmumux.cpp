...
double ME_gux_mupmumux::Calculate(const Phasespace::Phasespace &ps, int perm[],
...
void ME_gux_mupmumux::calculate_wavefunctions(const int perm[], const int hel[],
    ...
    FFV1_2(w[4], w[0], pars.GC_11, std::complex<double>(1e-9,0.0), w[5]);
    FFV1P0_3(w[2], w[3], pars.GC_3, std::complex<double>(1e-9,0.0), w[6]);
    FFV2_4_3(w[2], w[3], pars.GC_50, pars.GC_59, pars.MuZ, w[7]);
    FFV1_1(w[1], w[0], pars.GC_11, std::complex<double>(1e-9,0.0), w[8]);
