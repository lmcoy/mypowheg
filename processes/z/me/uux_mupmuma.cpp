...
double ME_uux_mupmuma::Calculate(const Phasespace::Phasespace &ps, int perm[],
                                 const Parameters_sm &param, int flag) {
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      ...
      {
          calculate_wavefunctions(perm, helicities[ihel], param, flag);
          t = matrix_uux_mupmuma();
...
void ME_uux_mupmuma::calculate_wavefunctions(const int perm[], const int hel[],
  ...
  if (flag != ONLYISR) {
      // FSR diagrams
      FFV1_0(w[6], w[3], w[5], pars.GC_3, amp[0]); // photon
      FFV2_4_0(w[6], w[3], w[7], pars.GC_50, pars.GC_59, amp[1]); // Z
      FFV1_0(w[2], w[8], w[5], pars.GC_3, amp[2]); // photon
      FFV2_4_0(w[2], w[8], w[7], pars.GC_50, pars.GC_59, amp[3]); // Z
  }
  if (flag != ONLYFSR) {
      // ISR diagrams
      FFV1_0(w[9], w[1], w[10], pars.GC_2, amp[4]); // photon
      FFV2_5_0(w[9], w[1], w[11], pars.GC_51, pars.GC_58, amp[5]); // Z
      FFV1_0(w[0], w[12], w[10], pars.GC_2, amp[6]); // photon
      FFV2_5_0(w[0], w[12], w[11], pars.GC_51, pars.GC_58, amp[7]); // Z
  }
}
double ME_uux_mupmuma::matrix_uux_mupmuma() 
{
  // Local variables
