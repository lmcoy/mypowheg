...
void VVVV4_1(std::complex<double> V2[], std::complex<double> V3[],
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - pow(M1, 2));
    V1[2] =
        denom * (OM1 * P1[0] * (-cI * (TMP14 * TMP27) + cI * (TMP15 * TMP22)) +
                 (-cI * (V3[2] * TMP22) + cI * (V2[2] * TMP27)));
    V1[3] =
        denom * (OM1 * P1[1] * (-cI * (TMP14 * TMP27) + cI * (TMP15 * TMP22)) +
                 (-cI * (V3[3] * TMP22) + cI * (V2[3] * TMP27)));
    V1[4] =
        denom * (OM1 * P1[2] * (-cI * (TMP14 * TMP27) + cI * (TMP15 * TMP22)) +
                 (-cI * (V3[4] * TMP22) + cI * (V2[4] * TMP27)));
    V1[5] =
        denom * (OM1 * P1[3] * (-cI * (TMP14 * TMP27) + cI * (TMP15 * TMP22)) +
