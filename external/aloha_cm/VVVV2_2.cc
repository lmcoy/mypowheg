...
void VVVV2_2(std::complex<double> V1[], std::complex<double> V3[],
    ...
    V2[2] =
        denom *
        (OM2 * P2[0] * (-2. * cI * (TMP9 * TMP27) +
                        cI * (TMP16 * TMP21 + TMP17 * TMP24)) +
         (-cI * (V3[2] * TMP21 + TMP17 * V4[2]) + 2. * cI * (V1[2] * TMP27)));
    V2[3] =
        denom *
        (OM2 * P2[1] * (-2. * cI * (TMP9 * TMP27) +
                        cI * (TMP16 * TMP21 + TMP17 * TMP24)) +
         (-cI * (V3[3] * TMP21 + TMP17 * V4[3]) + 2. * cI * (V1[3] * TMP27)));
    V2[4] =
        denom *
        (OM2 * P2[2] * (-2. * cI * (TMP9 * TMP27) +
                        cI * (TMP16 * TMP21 + TMP17 * TMP24)) +
         (-cI * (V3[4] * TMP21 + TMP17 * V4[4]) + 2. * cI * (V1[4] * TMP27)));
    V2[5] =
        denom *
        (OM2 * P2[3] * (-2. * cI * (TMP9 * TMP27) +
                        cI * (TMP16 * TMP21 + TMP17 * TMP24)) +
         (-cI * (V3[5] * TMP21 + TMP17 * V4[5]) + 2. * cI * (V1[5] * TMP27)));
}
