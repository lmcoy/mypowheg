...
void VVVV3_4(std::complex<double> V1[], std::complex<double> V2[],
    ...
    denom = COUP / (pow(P4[0], 2) - pow(P4[1], 2) - pow(P4[2], 2) -
                    pow(P4[3], 2) - pow(M4, 2));
    V4[2] =
        denom * (OM4 * P4[0] * (-cI * (TMP13 * TMP29) + cI * (TMP19 * TMP25)) +
                 (-cI * (V1[2] * TMP19) + cI * (V3[2] * TMP13)));
    V4[3] =
        denom * (OM4 * P4[1] * (-cI * (TMP13 * TMP29) + cI * (TMP19 * TMP25)) +
                 (-cI * (V1[3] * TMP19) + cI * (V3[3] * TMP13)));
    V4[4] =
        denom * (OM4 * P4[2] * (-cI * (TMP13 * TMP29) + cI * (TMP19 * TMP25)) +
                 (-cI * (V1[4] * TMP19) + cI * (V3[4] * TMP13)));
    V4[5] =
        denom * (OM4 * P4[3] * (-cI * (TMP13 * TMP29) + cI * (TMP19 * TMP25)) +
