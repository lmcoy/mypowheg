...
void FFV5_3(std::complex<double> F1[], std::complex<double> F2[],
    ...
    V3[2] = denom * -4. * cI * (OM3 * -1. / 4. * P3[0] * (TMP5 + 4. * (TMP8)) +
                                (+1. / 4. * (F2[4] * F1[2] + F2[5] * F1[3]) +
                                 F2[2] * F1[4] + F2[3] * F1[5]));
    V3[3] = denom * -4. * cI * (OM3 * -1. / 4. * P3[1] * (TMP5 + 4. * (TMP8)) +
                                (-1. / 4. * (F2[5] * F1[2] + F2[4] * F1[3]) +
                                 F2[3] * F1[4] + F2[2] * F1[5]));
    V3[4] = denom * 4. * cI *
            (OM3 * 1. / 4. * P3[2] * (TMP5 + 4. * (TMP8)) +
             (+1. / 4. * cI * (F2[5] * F1[2]) - 1. / 4. * cI * (F2[4] * F1[3]) -
              cI * (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
    V3[5] = denom * 4. * cI *
            (OM3 * 1. / 4. * P3[3] * (TMP5 + 4. * (TMP8)) +
             (+1. / 4. * (F2[4] * F1[2]) - 1. / 4. * (F2[5] * F1[3]) -
              F2[2] * F1[4] + F2[3] * F1[5]));
}
