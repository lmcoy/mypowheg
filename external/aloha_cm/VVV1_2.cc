...
void VVV1_2(std::complex<double> V1[], std::complex<double> V3[],
    ...
    denom = COUP / (pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) -
                    pow(P2[3], 2) - pow(M2, 2));
    V2[2] =
        denom * (OM2 * P2[0] * (TMP17 * (-cI * (TMP11) + cI * (TMP20)) +
                                (-cI * (TMP10 * TMP16) + cI * (TMP9 * TMP15))) +
                 (TMP17 * (-cI * (P3[0]) + cI * (P1[0])) +
                  (V1[2] * (-cI * (TMP15) + cI * (TMP16)) +
                   V3[2] * (-cI * (TMP9) + cI * (TMP10)))));
    V2[3] =
        denom * (OM2 * P2[1] * (TMP17 * (-cI * (TMP11) + cI * (TMP20)) +
                                (-cI * (TMP10 * TMP16) + cI * (TMP9 * TMP15))) +
                 (TMP17 * (-cI * (P3[1]) + cI * (P1[1])) +
                  (V1[3] * (-cI * (TMP15) + cI * (TMP16)) +
                   V3[3] * (-cI * (TMP9) + cI * (TMP10)))));
    V2[4] =
        denom * (OM2 * P2[2] * (TMP17 * (-cI * (TMP11) + cI * (TMP20)) +
                                (-cI * (TMP10 * TMP16) + cI * (TMP9 * TMP15))) +
                 (TMP17 * (-cI * (P3[2]) + cI * (P1[2])) +
                  (V1[4] * (-cI * (TMP15) + cI * (TMP16)) +
                   V3[4] * (-cI * (TMP9) + cI * (TMP10)))));
    V2[5] =
        denom * (OM2 * P2[3] * (TMP17 * (-cI * (TMP11) + cI * (TMP20)) +
                                (-cI * (TMP10 * TMP16) + cI * (TMP9 * TMP15))) +
                 (TMP17 * (-cI * (P3[3]) + cI * (P1[3])) +
                  (V1[5] * (-cI * (TMP15) + cI * (TMP16)) +
                   V3[5] * (-cI * (TMP9) + cI * (TMP10)))));
}
