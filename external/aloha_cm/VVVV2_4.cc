...
void VVVV2_4(std::complex<double> V1[], std::complex<double> V2[],
    ...
    V4[2] =
        denom *
        (OM4 * P4[0] * (-2. * cI * (TMP13 * TMP29) +
                        cI * (TMP19 * TMP25 + TMP17 * TMP26)) +
         (-cI * (V1[2] * TMP19 + V2[2] * TMP17) + 2. * cI * (V3[2] * TMP13)));
    V4[3] =
        denom *
        (OM4 * P4[1] * (-2. * cI * (TMP13 * TMP29) +
                        cI * (TMP19 * TMP25 + TMP17 * TMP26)) +
         (-cI * (V1[3] * TMP19 + V2[3] * TMP17) + 2. * cI * (V3[3] * TMP13)));
    V4[4] =
        denom *
        (OM4 * P4[2] * (-2. * cI * (TMP13 * TMP29) +
                        cI * (TMP19 * TMP25 + TMP17 * TMP26)) +
         (-cI * (V1[4] * TMP19 + V2[4] * TMP17) + 2. * cI * (V3[4] * TMP13)));
    V4[5] =
        denom *
        (OM4 * P4[3] * (-2. * cI * (TMP13 * TMP29) +
                        cI * (TMP19 * TMP25 + TMP17 * TMP26)) +
         (-cI * (V1[5] * TMP19 + V2[5] * TMP17) + 2. * cI * (V3[5] * TMP13)));
}
