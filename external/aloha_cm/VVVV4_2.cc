...
void VVVV4_2(std::complex<double> V1[], std::complex<double> V3[],
    ...
    denom = COUP / (pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) -
                    pow(P2[3], 2) - pow(M2, 2));
    V2[2] =
        denom * (OM2 * P2[0] * (-cI * (TMP9 * TMP27) + cI * (TMP17 * TMP24)) +
                 (-cI * (TMP17 * V4[2]) + cI * (V1[2] * TMP27)));
    V2[3] =
        denom * (OM2 * P2[1] * (-cI * (TMP9 * TMP27) + cI * (TMP17 * TMP24)) +
                 (-cI * (TMP17 * V4[3]) + cI * (V1[3] * TMP27)));
    V2[4] =
        denom * (OM2 * P2[2] * (-cI * (TMP9 * TMP27) + cI * (TMP17 * TMP24)) +
                 (-cI * (TMP17 * V4[4]) + cI * (V1[4] * TMP27)));
    V2[5] =
        denom * (OM2 * P2[3] * (-cI * (TMP9 * TMP27) + cI * (TMP17 * TMP24)) +
