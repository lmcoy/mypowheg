...
void VVVV5_4(std::complex<double> V1[], std::complex<double> V2[],
    ...
    V4[2] =
        denom * 1. / 2. *
        (OM4 * -P4[0] * (-2. * cI * (TMP19 * TMP25) +
                         cI * (TMP17 * TMP26 + TMP13 * TMP29)) +
         (-2. * cI * (V1[2] * TMP19) + cI * (V2[2] * TMP17 + V3[2] * TMP13)));
    V4[3] =
        denom * 1. / 2. *
        (OM4 * -P4[1] * (-2. * cI * (TMP19 * TMP25) +
                         cI * (TMP17 * TMP26 + TMP13 * TMP29)) +
         (-2. * cI * (V1[3] * TMP19) + cI * (V2[3] * TMP17 + V3[3] * TMP13)));
    V4[4] =
        denom * 1. / 2. *
        (OM4 * -P4[2] * (-2. * cI * (TMP19 * TMP25) +
                         cI * (TMP17 * TMP26 + TMP13 * TMP29)) +
         (-2. * cI * (V1[4] * TMP19) + cI * (V2[4] * TMP17 + V3[4] * TMP13)));
    V4[5] =
        denom * 1. / 2. *
        (OM4 * -P4[3] * (-2. * cI * (TMP19 * TMP25) +
                         cI * (TMP17 * TMP26 + TMP13 * TMP29)) +
         (-2. * cI * (V1[5] * TMP19) + cI * (V2[5] * TMP17 + V3[5] * TMP13)));
}
