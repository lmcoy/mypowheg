...
void VVVV5_1(std::complex<double> V2[], std::complex<double> V3[],
    ...
    V1[2] =
        denom * 1. / 2. *
        (OM1 * -P1[0] * (-2. * cI * (TMP19 * TMP23) +
                         cI * (TMP15 * TMP22 + TMP14 * TMP27)) +
         (-2. * cI * (TMP19 * V4[2]) + cI * (V3[2] * TMP22 + V2[2] * TMP27)));
    V1[3] =
        denom * 1. / 2. *
        (OM1 * -P1[1] * (-2. * cI * (TMP19 * TMP23) +
                         cI * (TMP15 * TMP22 + TMP14 * TMP27)) +
         (-2. * cI * (TMP19 * V4[3]) + cI * (V3[3] * TMP22 + V2[3] * TMP27)));
    V1[4] =
        denom * 1. / 2. *
        (OM1 * -P1[2] * (-2. * cI * (TMP19 * TMP23) +
                         cI * (TMP15 * TMP22 + TMP14 * TMP27)) +
         (-2. * cI * (TMP19 * V4[4]) + cI * (V3[4] * TMP22 + V2[4] * TMP27)));
    V1[5] =
        denom * 1. / 2. *
        (OM1 * -P1[3] * (-2. * cI * (TMP19 * TMP23) +
                         cI * (TMP15 * TMP22 + TMP14 * TMP27)) +
         (-2. * cI * (TMP19 * V4[5]) + cI * (V3[5] * TMP22 + V2[5] * TMP27)));
}
