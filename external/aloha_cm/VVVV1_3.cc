...
void VVVV1_3(std::complex<double> V1[], std::complex<double> V2[],
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - pow(M3, 2));
    V3[2] =
        denom * (OM3 * P3[0] * (-cI * (TMP10 * TMP22) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[2] * TMP21) + cI * (V1[2] * TMP22)));
    V3[3] =
        denom * (OM3 * P3[1] * (-cI * (TMP10 * TMP22) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[3] * TMP21) + cI * (V1[3] * TMP22)));
    V3[4] =
        denom * (OM3 * P3[2] * (-cI * (TMP10 * TMP22) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[4] * TMP21) + cI * (V1[4] * TMP22)));
    V3[5] =
        denom * (OM3 * P3[3] * (-cI * (TMP10 * TMP22) + cI * (TMP18 * TMP21)) +
