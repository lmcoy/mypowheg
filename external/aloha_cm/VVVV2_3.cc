...
void VVVV2_3(std::complex<double> V1[], std::complex<double> V2[],
    ...
    V3[2] =
        denom *
        (OM3 * P3[0] * (-2. * cI * (TMP13 * TMP28) +
                        cI * (TMP18 * TMP21 + TMP10 * TMP22)) +
         (-cI * (V2[2] * TMP21 + V1[2] * TMP22) + 2. * cI * (TMP13 * V4[2])));
    V3[3] =
        denom *
        (OM3 * P3[1] * (-2. * cI * (TMP13 * TMP28) +
                        cI * (TMP18 * TMP21 + TMP10 * TMP22)) +
         (-cI * (V2[3] * TMP21 + V1[3] * TMP22) + 2. * cI * (TMP13 * V4[3])));
    V3[4] =
        denom *
        (OM3 * P3[2] * (-2. * cI * (TMP13 * TMP28) +
                        cI * (TMP18 * TMP21 + TMP10 * TMP22)) +
         (-cI * (V2[4] * TMP21 + V1[4] * TMP22) + 2. * cI * (TMP13 * V4[4])));
    V3[5] =
        denom *
        (OM3 * P3[3] * (-2. * cI * (TMP13 * TMP28) +
                        cI * (TMP18 * TMP21 + TMP10 * TMP22)) +
         (-cI * (V2[5] * TMP21 + V1[5] * TMP22) + 2. * cI * (TMP13 * V4[5])));
}
