...
void VVVV3_3(std::complex<double> V1[], std::complex<double> V2[],
    ...
    denom = COUP / (pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) -
                    pow(P3[3], 2) - pow(M3, 2));
    V3[2] =
        denom * (OM3 * P3[0] * (-cI * (TMP13 * TMP28) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[2] * TMP21) + cI * (TMP13 * V4[2])));
    V3[3] =
        denom * (OM3 * P3[1] * (-cI * (TMP13 * TMP28) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[3] * TMP21) + cI * (TMP13 * V4[3])));
    V3[4] =
        denom * (OM3 * P3[2] * (-cI * (TMP13 * TMP28) + cI * (TMP18 * TMP21)) +
                 (-cI * (V2[4] * TMP21) + cI * (TMP13 * V4[4])));
    V3[5] =
        denom * (OM3 * P3[3] * (-cI * (TMP13 * TMP28) + cI * (TMP18 * TMP21)) +
