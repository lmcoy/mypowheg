...
void VVVV1_1(std::complex<double> V2[], std::complex<double> V3[],
    ...
    denom = COUP / (pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) -
                    pow(P1[3], 2) - pow(M1, 2));
    V1[2] =
        denom * (OM1 * P1[0] * (-cI * (TMP15 * TMP22) + cI * (TMP19 * TMP23)) +
                 (-cI * (TMP19 * V4[2]) + cI * (V3[2] * TMP22)));
    V1[3] =
        denom * (OM1 * P1[1] * (-cI * (TMP15 * TMP22) + cI * (TMP19 * TMP23)) +
                 (-cI * (TMP19 * V4[3]) + cI * (V3[3] * TMP22)));
    V1[4] =
        denom * (OM1 * P1[2] * (-cI * (TMP15 * TMP22) + cI * (TMP19 * TMP23)) +
                 (-cI * (TMP19 * V4[4]) + cI * (V3[4] * TMP22)));
    V1[5] =
        denom * (OM1 * P1[3] * (-cI * (TMP15 * TMP22) + cI * (TMP19 * TMP23)) +
