...
void VVVV2_1(std::complex<double> V2[], std::complex<double> V3[],
    ...
    V1[2] =
        denom *
        (OM1 * P1[0] * (-2. * cI * (TMP14 * TMP27) +
                        cI * (TMP19 * TMP23 + TMP15 * TMP22)) +
         (-cI * (TMP19 * V4[2] + V3[2] * TMP22) + 2. * cI * (V2[2] * TMP27)));
    V1[3] =
        denom *
        (OM1 * P1[1] * (-2. * cI * (TMP14 * TMP27) +
                        cI * (TMP19 * TMP23 + TMP15 * TMP22)) +
         (-cI * (TMP19 * V4[3] + V3[3] * TMP22) + 2. * cI * (V2[3] * TMP27)));
    V1[4] =
        denom *
        (OM1 * P1[2] * (-2. * cI * (TMP14 * TMP27) +
                        cI * (TMP19 * TMP23 + TMP15 * TMP22)) +
         (-cI * (TMP19 * V4[4] + V3[4] * TMP22) + 2. * cI * (V2[4] * TMP27)));
    V1[5] =
        denom *
        (OM1 * P1[3] * (-2. * cI * (TMP14 * TMP27) +
                        cI * (TMP19 * TMP23 + TMP15 * TMP22)) +
         (-cI * (TMP19 * V4[5] + V3[5] * TMP22) + 2. * cI * (V2[5] * TMP27)));
}
